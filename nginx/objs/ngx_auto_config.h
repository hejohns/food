#define NGX_CONFIGURE " --prefix=/home/hejohns/documentsNoSync/food/nginx/local --without-http_rewrite_module --without-http_gzip_module"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/hejohns/documentsNoSync/food/nginx/local/"
#endif
